...
class Ajax_pagination{
	...
	var $last_link		= 'Last';
	var $uri_segment	= 3;
	var $full_tag_open	= '<div class="paginationArea">';
	...
	function create_links(){
        ...
        function getData(page){  
        	...
        	var order_by="order=<?= isset($_GET['order'])?$_GET['order']:'new'?>";
            $.ajax({
                method: "POST",
                url: "<?php echo $this->base_url; ?>"+page+"?"+order_by+"&min="+min_price+"&max="+max_price,
                data: { page: page },
                beforeSend: function(){
