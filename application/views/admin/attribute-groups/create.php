...
<div class="card-box">
<form class="form-horizontal" method="post" role="form" action="<?= base_url('admin/attribute-groups/store')?>" enctype="multipart/form-data" id="create-attribute-groups">
<div class="row">
<div class="col-md-12">
    ...
    <div class="form-group text-right m-b-0">
        <div class="col-md-12">
            <button class="btn btn-success waves-effect waves-light" type="submit" name="add-attribute-groups" value="save slider">Submit</button>
