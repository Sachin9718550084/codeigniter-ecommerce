...
<h4 class="page-title"> categories Manager</h4>
<ol class="breadcrumb p-0 m-0">
<li><a href="<?= base_url('admin/categories')?>">List  categories</a></li>
...
<div class="card-box">
<form class="form-horizontal" method="post" role="form" action="<?= base_url('admin/categories/store')?>" enctype="multipart/form-data" id="category-form">
<div class="row">
<div class="col-md-12">
    ...
    <div class="form-group">
        <div class="col-md-12">
            <label class="control-label">Parent Category</label>
              <?= form_dropdown("isParent",$categories,null,["class"=>"form-control select2"])?>
        </div>
    </div>
    <div class="form-group">
        <div class="col-md-12">
    ...
    <div class="form-group text-right m-b-0">
        <div class="col-md-12">
            <button class="btn btn-success waves-effect waves-light" type="submit" name="add-categories" value="save blog category">Submit</button>
