...
<div class="card-box">
<form class="form-horizontal" method="post" role="form" action="<?= base_url('admin/categories/update/'.$data->id)?>" enctype="multipart/form-data" id="edit-category-form">
<div class="row">
<div class="col-md-12">
    ...
    <div class="form-group">
        ...
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" data-id="<?= $data->id;?>" placeholder="Enter seo_url..." value="<?= $data->seo_url;?>" name="seo_url">
        </div>
  ...
  <div class="form-group">
        <div class="col-md-12">
            <label class="control-label">Parent Category</label>
              <?= form_dropdown("isParent",$categories,$data->isParent,["class"=>"form-control select2"])?>
        </div>
    </div>
    <div class="form-group">
        <div class="col-md-12">
