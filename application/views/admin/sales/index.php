                            ...
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    <div class="row" style="margin-bottom: 15px;">
                                        <div class="col-sm-6"><h4 class="m-t-0 header-title"><b>View sales Manager</b></h4></div>
                                        <div class="col-sm-6 text-right">
                                            <a href="<?= base_url('admin/sales/create')?>" class="btn btn-success btn-bordered waves-effect w-md waves-light">Add sales </a>
                                        </div>
                                    </div>
...
<tr>
<td><?= $single->id?></td>
<td><?= $single->start_date?>  - <?= $single->end_date?></td>


<td>

    <a href="<?= base_url('admin/sales/edit/'.$single->id)?>" class="btn btn-icon btn-sm waves-effect waves-light btn-info"> <i class="fa fa-pencil"></i> </a>
    <a  href="<?= base_url('admin/sales/delete/'.$single->id)?>"  class="btn btn-icon btn-sm waves-effect waves-light btn-danger" onclick="return confirm('Are you want to delete?')"> <i class="fa fa-trash-o"></i> </a>
</td>
</tr>
<?php endforeach;?>
                                        </tbody>
