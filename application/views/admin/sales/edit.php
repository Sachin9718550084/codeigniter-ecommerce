...
<li><a href="<?= base_url('admin/sales')?>">List sales</a></li>
...
<div class="card-box">
<form class="form-horizontal" method="post" role="form" action="<?= base_url('admin/sales/update/'.$data->id)?>" enctype="multipart/form-data"  id="edit-setting-form">
<div class="row">
<div class="col-md-12">
     ...
     <div class="form-group">
        ...
        <div class="col-md-6">
            ...
            <input type="date" class="form-control" placeholder="Enter Start Date..." name="start_date" value="<?= $data->start_date?>" >
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-6">
            ...
            <input type="date" class="form-control" placeholder="Enter end Date..." name="end_date" value="<?= $data->end_date?>" >
        </div>
       
    </div>
<?php $values=explode(",",$data->value);?>
    <div class="form-group">
        <div class="col-md-6">
            <label class="control-label">Value</label>
            <select name="values[]" id="select2data" multiple>
                <?php foreach($this->common->getProducts() as $p):?>
                    <option value="<?= $p->id?>" <?= in_array($p->id,$values)?'selected':''?>><?= $p->title?></option>
                <?php endforeach;?>
    ...
    <div class="form-group text-right m-b-0">
        <div class="col-md-12">
            <button class="btn btn-success waves-effect waves-light" type="submit" name="add-settings" value="Update settings">Submit</button>
