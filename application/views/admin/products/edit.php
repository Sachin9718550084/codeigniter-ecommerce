...
<div class="card-box">
<form class="form-horizontal" method="post" role="form" action="<?= base_url('admin/products/update/'.$data->id)?>" enctype="multipart/form-data" id="products">
<div class="row">
      <!-- Nav tabs -->
  ...
  <div class="tab-content">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input class="form-control" name="seo_url" value="<?= $data->seo_url; ?>" type="text" id="seo_url">
            <span class="text-danger"></span>
        </div>
    </div>
...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <?= form_dropdown("manufacture_id",$this->common->getManufactureListProduct(),$data->manufacture_id,["class"=>"form-control select2"])?>
    ...
    <div class="col-md-6">
        <div class="form-group">
            <label for="brand">Brand</label>
             <?= form_dropdown("brnad_id",$this->common->getBrandListProduct(),$data->brand_id,["class"=>"form-control"]);?>
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <?= form_dropdown("category",$this->common->getCategoryListProduct(),$data->category_id,["class"=>"form-control"]);?>
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input class="form-control" placeholder="Enter Price" min="0" max="999999" name="price" type="number" id="price" value="<?= $data->price; ?>">
            <span class="text-danger"></span>
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input class="form-control" placeholder="Enter Saleing Price" min="0" max="999999" name="saleing_price" type="number" id="saleing_price" value="<?= $data->saleing_price; ?>">
            <span class="text-danger"></span>
        </div>
    </div>
</div>    </div>
    ...
    <div class="col-md-6">
        ...
        <img src="<?= base_url().'assets/uploads/'.$data->featureImage; ?>" width="50" height="50">
        <?php endif;?>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <span class="text-danger"></span>
            <div class="row">
                <?php foreach($this->common->getGalleriesImageProduct($data->id) as $i):?>
                    <div class="col-md-3 image-section-gaurav">
                        <img src="<?= base_url().'assets/products/'.$i->image; ?>" height="50px"> <span class="badge badge-danger delete-image-data" data-id="<?= $i->id?>"><i class="fa fa-trash"></i></span>       
                    </div>
                <?php endforeach;?>
            </div>
        </div>
...
<div class="attribute-field">
    <?php foreach($this->common->getProductAttributes($data->id) as $i):?>
...
<div class="row">
    <div class="col-md-3">
      ...
      <?= form_dropdown("attribute_group_id[]",$this->common->getAllAttributeGroups(),$i->attribute_group_id,["class"=>"form-control attribute_group_field"]);?>
    </div>
    <div class="col-md-3">
    
          <?= form_dropdown("attribute_id[]", $this->common->getAttributeViaGourpID($i->attribute_group_id),$i->attribute_id,["class"=>"form-control attribute_id_ajax"]);?>
    </div>
    <div class="col-md-3">

      <input class="form-control" placeholder="Enter Value" name="value[]" value="<?= $i->value?>" type="text">
    </div>
    <div class="col-md-3"> 
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input class="form-control" name="meta_title" value="<?= $data->meta_title; ?>" type="text" id="meta_title">
            <span class="text-danger"></span>
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input class="form-control" name="meta_keywords" value="<?= $data->meta_keywords; ?>" type="text" id="meta_keywords">
            <span class="text-danger"></span>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-md-12">
        <div class="form-group">
            ...
            <textarea class="form-control" name="meta_description" cols="50" rows="10" id="meta_description"><?= $data->meta_description; ?></textarea>
            <span class="text-danger"></span>
        </div>
    </div>
</div>    </div>
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <select class="form-control" id="isSale" name="is_sale">
                <option value="0" <?= ($data->is_sale==0)?'selected':'';?> >False</option>
                <option value="1" <?= ($data->is_sale==1)?'selected':'';?> >True</option>
            </select>
            <span class="text-danger"></span>
        </div>
    </div>
    <div class="col-md-6 isSale">
        <div class="form-group">
            ...
            <input class="form-control" name="sale_price"  value="<?= $data->sale_price; ?>" type="number" id="sale_price">
            <span class="text-danger"></span>
        </div>
    </div>
</div>
<div class="row isSale">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input class="form-control" name="sale_start_date" value="<?= $data->sale_start_date; ?>" type="text" id="sale_start_date">
            <span class="text-danger"></span>
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input class="form-control" name="sale_end_date" value="<?= $data->sale_end_date; ?>" type="text" id="sale_end_date">
            <span class="text-danger"></span>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input class="form-control" name="stock" value="<?= $data->stock; ?>" type="text" id="stock">
            <span class="text-danger"></span>
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            ...
            <select class="form-control" id="is_stock_management" name="is_stock_management">
                <option value="0" <?= ($data->is_stock_management==0)?'selected':'';?> >False</option>
                <option value="1" <?= ($data->is_stock_management==1)?'selected':'';?> >True</option>
            </select>
            <span class="text-danger"></span>
        </div>
    </div>
...
<div class="row is_stock_management">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input class="form-control" name="quantity" value="<?= $data->quantity; ?>" type="text" id="quantity">
            <span class="text-danger"></span>
        </div>
    </div>
    ...
    <div class="col-md-6 ">
        <div class="form-group">
            ...
            <input class="form-control" name="sku" type="number" value="<?= $data->sku; ?>" id="sku">
            <span class="text-danger"></span>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-md-12">
        <div class="form-group">
            ...
            <textarea class="form-control" name="shortDescription" cols="50" rows="10" id="shortDescription"><?= $data->shortDescription; ?></textarea>
            <span class="text-danger"></span>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-md-12">
        <div class="form-group">
            ...
            <textarea class="form-control" name="longDescription" cols="50" rows="10" id="longDescription"><?= $data->longDescription; ?></textarea>
            <span class="text-danger"></span>
        </div>
    </div>
</div>
