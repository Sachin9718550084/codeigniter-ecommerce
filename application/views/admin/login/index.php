...
<!-- App title -->
<title>Login | <?= $this->config->item('title')?></title>
                ...
                <div class="account-content">
                    ...
                    <?php $this->load->view('admin/include/message');?>
                        ...
                        <div class="form-group text-center m-t-30">
                            <div class="col-sm-12">
                                <a href="<?= base_url('admin/forget-password')?>" class="text-muted"><i class="fa fa-lock m-r-5"></i> Forgot your password?</a>
                            </div>
                        </div>

                        <div class="form-group account-btn text-center m-t-10">
                            <div class="col-xs-12">
                                <button class="btn w-md btn-bordered btn-danger waves-effect waves-light" type="submit" name="login" value="login">Log In</button>
                            </div>
                        </div>
