...
<!-- App title -->
<title>Reset Password | <?= $this->config->item('title')?></title>
        ...
        <div class="wrapper-page">
            ...
            <div class="m-t-40 account-pages">
                ...
                <div class="account-content">
                    <form class="form-horizontal" method="post" id="resetpassword-form">
<?php $this->load->view('admin/include/message');?>
                        ...
                        <div class="form-group account-btn text-center m-t-10">
                            <div class="col-xs-12">
                                <button class="btn w-md btn-bordered btn-danger waves-effect waves-light" type="submit" name="reset-password" value="Reset Password">Reset Password</button>
                            </div>
                        </div>
