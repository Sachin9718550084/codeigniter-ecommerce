...
<li><a href="<?= base_url('admin/portfolios')?>">List portfolios</a></li>
...
<div class="card-box">
<form class="form-horizontal" method="post" role="form" action="<?= base_url('admin/portfolios/update/'.$data->id)?>" enctype="multipart/form-data" id="edit-portfolio">
<div class="row">
<div class="col-md-12">
    ...
    <div class="form-group">
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" value="<?= $data->link;?>" placeholder="Enter Link..." name="link">
        </div>
        <div class="col-md-6">
            <label class="control-label">Author</label>
            <input type="text" class="form-control" value="<?= $data->author;?>" placeholder="Enter Author..." name="author">
        </div>
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <textarea class="form-control" placeholder="Enter Description..." name="description"><?= $data->description;?></textarea>
        </div>
    </div>

    <div class="form-group text-right m-b-0">
        <div class="col-md-12">
            <button class="btn btn-success waves-effect waves-light" type="submit" name="add-portfolios" value="save portfolios">Submit</button>
