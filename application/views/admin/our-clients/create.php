...
<li class="active">Add Our Client</li>
</ol>
...
<div class="card-box">
<form class="form-horizontal" method="post" role="form" action="<?= base_url('admin/our-clients/store')?>" enctype="multipart/form-data" id="our-client">
<div class="row">
<div class="col-md-12">
