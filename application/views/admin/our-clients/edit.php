...
<li><a href="<?= base_url('admin/our-clients')?>">List our clients</a></li>
<li class="active">Edit Our Client</li>
</ol>
...
<div class="card-box">
<form class="form-horizontal" method="post" role="form" action="<?= base_url('admin/our-clients/update/'.$data->id)?>" enctype="multipart/form-data" id="edit-our-client">
<div class="row">
<div class="col-md-12">
    ...
    <div class="form-group text-right m-b-0">
        <div class="col-md-12">
            <button class="btn btn-success waves-effect waves-light" type="submit" name="add-our-clients" value="save our-clients">Submit</button>
