...
<li><a href="<?= base_url('admin/sliders')?>">List settings</a></li>
...
<div class="card-box">
<form class="form-horizontal" method="post" role="form" action="<?= base_url('admin/settings/update/'.$data->id)?>" enctype="multipart/form-data"  id="edit-setting-form">
<div class="row">
<div class="col-md-12">
    ...
    <div class="form-group">
        ...
        <div class="col-md-6">
            ...
            <input type="text" readonly class="form-control" placeholder="Enter Name..." name="name" value="<?= $data->name;?>">
        </div>
    ...
    <div class="form-group">
        <div class="col-md-6">
            ...
            <input type="text" class="form-control"  value="<?= $data->value;?>" placeholder="Enter Value..." name="value">
        </div>
