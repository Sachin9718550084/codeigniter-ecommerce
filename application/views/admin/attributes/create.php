...
<div class="card-box">
<form class="form-horizontal" method="post" role="form" action="<?= base_url('admin/attributes/store')?>" enctype="multipart/form-data" id="create-attributes">
<div class="row">
<div class="col-md-12">
    ...
    <div class="form-group">
        ...
        <div class="col-md-6">
            ...
            <?= form_dropdown("attribute_group_id",$categories,null,["class"=>"form-control select2"])?>
        </div>
    </div>
