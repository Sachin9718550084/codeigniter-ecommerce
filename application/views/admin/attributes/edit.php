...
<li><a href="<?= base_url('admin/attributes')?>">List attributes</a></li>
...
<div class="card-box">
<form class="form-horizontal" method="post" role="form" action="<?= base_url('admin/attributes/update/'.$data->id)?>" enctype="multipart/form-data" id="edit-attributes">
<div class="row">
<div class="col-md-12">
    ...
    <div class="form-group">
     ...
     <div class="col-md-6">
            ...
            <?= form_dropdown("attribute_group_id",$categories,$data->attribute_group_id,["class"=>"form-control select2"])?>
        </div>
    </div>
    ...
    <div class="form-group text-right m-b-0">
        <div class="col-md-12">
            <button class="btn btn-success waves-effect waves-light" type="submit" name="add-attributes" value="save attributes">Submit</button>
