                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">attributes Manager </h4>
                                    <ol class="breadcrumb p-0 m-0">
                                        <li><a href="#">attributes Manager</a></li>
                            ...
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    <div class="row" style="margin-bottom: 15px;">
                                        <div class="col-sm-6"><h4 class="m-t-0 header-title"><b>View attributes Manager</b></h4></div>
                                        <div class="col-sm-6 text-right">
                                            <a href="<?= base_url('admin/attributes/create')?>" class="btn btn-success btn-bordered waves-effect w-md waves-light">Add attribute  </a>
                                        </div>
                                    </div>
...
<td><?= $single->id?></td>
<td><?= $single->name?></td>
<td><?= $categories[$single->attribute_group_id]?></td>

<td>
   
    <a href="<?= base_url('admin/attributes/edit/'.$single->id)?>" class="btn btn-icon btn-sm waves-effect waves-light btn-info"> <i class="fa fa-pencil"></i> </a>
    <a  href="<?= base_url('admin/attributes/delete/'.$single->id)?>"  class="btn btn-icon btn-sm waves-effect waves-light btn-danger" onclick="return confirm('Are you want to delete?')"> <i class="fa fa-trash-o"></i> </a>
</td>
</tr>
<?php endforeach;?>
                                        </tbody>
