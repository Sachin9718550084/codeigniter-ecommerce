...
<div class="card-box">
<form class="form-horizontal" method="post" role="form" action="<?= base_url('admin/cms/update/'.$data->id)?>" enctype="multipart/form-data">
<div class="row">
<div class="col-md-12">
    ...
    <div class="form-group">
        ...
        <div class="col-md-6">
            ...
            <?= form_dropdown('templete',$this->common->getTemplete(),$data->templete,["class"=>"form-control"])?>
        </div>
    </div>
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <textarea class="form-control" placeholder="Enter shortDescription..." id="shortDescription" name="shortDescription"><?= $data->shortDescription;?></textarea>
        </div>
    </div>
    <div class="form-group">
        <div class="col-md-12">
            <label class="control-label">mediumDescription</label>
            <textarea class="form-control" placeholder="Enter mediumDescription..." id="mediumDescription" name="mediumDescription"><?= $data->mediumDescription;?></textarea>
        </div>
    </div>
    <div class="form-group">
        <div class="col-md-12">
