...
<li><a href="<?= base_url('admin/galleries')?>">List galleries</a></li>
...
<div class="card-box">
<form class="form-horizontal" method="post" role="form" action="<?= base_url('admin/galleries/update/'.$data->id)?>" enctype="multipart/form-data" id="edit-gallery">
<div class="row">
<div class="col-md-12">
    ...
    <div class="form-group text-right m-b-0">
        <div class="col-md-12">
            <button class="btn btn-success waves-effect waves-light" type="submit" name="add-galleries" value="save galleries">Submit</button>
