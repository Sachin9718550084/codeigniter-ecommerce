                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">galleries Manager </h4>
                                    <ol class="breadcrumb p-0 m-0">
                                        <li><a href="#">galleries Manager</a></li>
                            ...
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    <div class="row" style="margin-bottom: 15px;">
                                        <div class="col-sm-6"><h4 class="m-t-0 header-title"><b>View galleries Manager</b></h4></div>
                                        <div class="col-sm-6 text-right">
                                            <a href="<?= base_url('admin/galleries/create')?>" class="btn btn-success btn-bordered waves-effect w-md waves-light">Add gallery </a>
                                        </div>
                                    </div>
...
<td>
    ...
    <a href="<?= base_url('admin/galleries/edit/'.$single->id)?>" class="btn btn-icon btn-sm waves-effect waves-light btn-info"> <i class="fa fa-pencil"></i> </a>
    <a  href="<?= base_url('admin/galleries/delete/'.$single->id)?>"  class="btn btn-icon btn-sm waves-effect waves-light btn-danger" onclick="return confirm('Are you want to delete?')"> <i class="fa fa-trash-o"></i> </a>
</td>
</tr>
<?php endforeach;?>
                                        </tbody>
