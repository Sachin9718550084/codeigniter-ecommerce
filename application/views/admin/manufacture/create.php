...
<h4 class="page-title">Manufacture Manager</h4>
<ol class="breadcrumb p-0 m-0">
<li><a href="<?= base_url('admin/manufacture')?>">List Manufacture</a></li>
...
<div class="card-box">
<form class="form-horizontal" method="post" role="form" action="<?= base_url('admin/manufacture/store')?>" enctype="multipart/form-data" id="manufacture">
<div class="row">
<div class="col-md-12">
    ...
    <div class="form-group text-right m-b-0">
        <div class="col-md-12">
            <button class="btn btn-success waves-effect waves-light" type="submit" name="add-manufacture" value="save blog category">Submit</button>
