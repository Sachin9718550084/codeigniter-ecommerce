...
<li class="active">Change Profile Data</li>
</ol>
...
<?php $this->load->view('admin/include/message');?>
    ...
    <div class="form-group text-right m-b-0">
        <div class="col-md-12">
            <button name="change-profile" value="Change Profile" class="btn btn-success waves-effect waves-light" type="submit">Change Profile</button>
