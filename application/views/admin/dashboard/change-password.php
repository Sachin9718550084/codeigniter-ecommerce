...
<div class="card-box">
<form class="form-horizontal" role="form" method="post" id="change-password">
<div class="row">
<div class="col-md-12">
   ...
   <?php $this->load->view('admin/include/message');?>
    ...
    <div class="form-group">
        ...
        <div class="col-md-12">
            ...
            <input type="text" class="form-control" required placeholder="Enter Old Password..." name="old_password">
        </div>
        <div class="col-md-12">
            <label class="control-label">New Password</label>
            <input type="text" class="form-control" required placeholder="Enter New Password..." name="new_password" id="cnew_password">
        </div>
        <div class="col-md-12">
            <label class="control-label">Confirm Password</label>
            <input type="text" class="form-control" required placeholder="Enter Confirm Password..." name="confirm_password">
        </div>
    </div>

    <div class="form-group text-right m-b-0">
        <div class="col-md-12">
            <button class="btn btn-success waves-effect waves-light" type="submit" name="change_password" value="Change Password">Change Password</button>
