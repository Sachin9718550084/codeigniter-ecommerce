...
<div class="card-box">
<form class="form-horizontal" method="post" role="form" action="<?= base_url('admin/testimonials/store')?>" enctype="multipart/form-data" id="testimonial">
<div class="row">
<div class="col-md-12">
    ...
    <div class="form-group text-right m-b-0">
        <div class="col-md-12">
            <button class="btn btn-success waves-effect waves-light" type="submit" name="add-testimonials" value="save testimonials">Submit</button>
