...
<div class="card-box">
<form class="form-horizontal" method="post" role="form" action="<?= base_url('admin/faqs/store')?>" enctype="multipart/form-data"  id="faq">
<div class="row">
<div class="col-md-12">
    <div class="form-group">
        <div class="col-md-12">
            <label class="control-label">FAQ Category</label>
            <?= form_dropdown("faq_category_id",$categories,null,["class"=>"form-control select2"])?>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <textarea class="form-control" placeholder="Enter Answer..." name="answer"></textarea>
        </div>
    </div>
