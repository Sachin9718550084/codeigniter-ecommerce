...
<li><a href="<?= base_url('admin/sliders')?>">List FAQ</a></li>
...
<div class="card-box">
<form class="form-horizontal" method="post" role="form" action="<?= base_url('admin/faqs/update/'.$data->id)?>" enctype="multipart/form-data" id="edit-faq">
<div class="row">
<div class="col-md-12">
    <div class="form-group">
        <div class="col-md-12">
            <label class="control-label">FAQ Category</label>
            <?= form_dropdown("faq_category_id",$categories,$data->faq_category_id,["class"=>"form-control select2"])?>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-md-12">
            ...
            <input type="text" class="form-control" value="<?= $data->question;?>" placeholder="Enter Question..." name="question">
        </div>
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <textarea class="form-control" placeholder="Enter Answer..." name="answer"><?= $data->answer;?></textarea>
        </div>
    </div>

    <div class="form-group text-right m-b-0">
        <div class="col-md-12">
            <button class="btn btn-success waves-effect waves-light" type="submit" name="add-faqs" value="save faqs">Submit</button>
