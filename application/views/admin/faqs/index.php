                            ...
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    <div class="row" style="margin-bottom: 15px;">
                                        <div class="col-sm-6"><h4 class="m-t-0 header-title"><b>View FAQ Manager</b></h4></div>
                                        <div class="col-sm-6 text-right">
                                            <a href="<?= base_url('admin/faqs/create')?>" class="btn btn-success btn-bordered waves-effect w-md waves-light">Add FAQ </a>
                                        </div>
                                    </div>
...
<td>
    ...
    <a href="<?= base_url('admin/faqs/edit/'.$single->id)?>" class="btn btn-icon btn-sm waves-effect waves-light btn-info"> <i class="fa fa-pencil"></i> </a>
    <a  href="<?= base_url('admin/faqs/delete/'.$single->id)?>"  class="btn btn-icon btn-sm waves-effect waves-light btn-danger" onclick="return confirm('Are you want to delete?')"> <i class="fa fa-trash-o"></i> </a>
</td>
</tr>
<?php endforeach;?>
                                        </tbody>
