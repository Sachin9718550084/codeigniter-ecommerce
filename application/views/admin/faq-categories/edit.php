...
<li><a href="<?= base_url('admin/faq-categories')?>">List faq-categories</a></li>
...
<div class="card-box">
<form class="form-horizontal" method="post" role="form" action="<?= base_url('admin/faq-categories/update/'.$data->id)?>" enctype="multipart/form-data">
<div class="row">
<div class="col-md-12">
    ...
    <div class="form-group text-right m-b-0">
        <div class="col-md-12">
            <button class="btn btn-success waves-effect waves-light" type="submit" name="add-faq-categories" value="save faq-categories">Submit</button>
