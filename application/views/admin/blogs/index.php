                            ...
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    <div class="row" style="margin-bottom: 15px;">
                                        <div class="col-sm-6"><h4 class="m-t-0 header-title"><b>View Blog  Manager</b></h4></div>
                                        <div class="col-sm-6 text-right">
                                            <a href="<?= base_url('admin/blogs/create')?>" class="btn btn-success btn-bordered waves-effect w-md waves-light">Add Blog  </a>
                                        </div>
                                    </div>
...
<td>
<?php if(is_null($single->image) || $single->image==""):?>
<?php else:?>
    <img src="<?= base_url('assets/uploads/'.$single->image)?>" width="50" height="50" />
<?php endif;?>
</td>

<td>
<?php if(is_null($single->featureImage) || $single->featureImage==""):?>
<?php else:?>
    <img src="<?= base_url('assets/uploads/'.$single->featureImage)?>" width="50" height="50" />
<?php endif;?>
</td>
<td><?= $categories[$single->blog_category_id];?></td>

<td>

    <a href="<?= base_url('admin/blogs/edit/'.$single->id)?>" class="btn btn-icon btn-sm waves-effect waves-light btn-info"> <i class="fa fa-pencil"></i> </a>
    <a  href="<?= base_url('admin/blogs/delete/'.$single->id)?>"  class="btn btn-icon btn-sm waves-effect waves-light btn-danger" onclick="return confirm('Are you want to delete?')"> <i class="fa fa-trash-o"></i> </a>
</td>
</tr>
<?php endforeach;?>
                                        </tbody>
