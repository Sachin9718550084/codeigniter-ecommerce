...
<div class="card-box">
<form class="form-horizontal" method="post" role="form" action="<?= base_url('admin/blogs/store')?>" enctype="multipart/form-data" id="blogs">
<div class="row">
<div class="col-md-12">
    ...
    <div class="form-group">
        ...
        <div class="col-md-6">
            ...
            <?= form_dropdown("blog_category_id",$categories,null,["class"=>"form-control select2"])?>
        </div>
        <div class="col-md-6">
               <div class="form-group">
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <textarea class="form-control" placeholder="Enter short Description..." id="shortDescription" name="shortDescription"></textarea>
        </div>
    </div>
    <div class="form-group">
        <div class="col-md-12">
