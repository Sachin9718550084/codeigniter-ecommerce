...
<li><a href="<?= base_url('admin/blogs')?>">List blog </a></li>
...
<div class="card-box">
<form class="form-horizontal" method="post" role="form" action="<?= base_url('admin/blogs/update/'.$data->id)?>" enctype="multipart/form-data" id="edit-blogs">
<div class="row">
<div class="col-md-12">
    ...
    <div class="form-group">
        ...
        <div class="col-md-6">
            ...
            <?= form_dropdown("blog_category_id",$categories,$data->blog_category_id,["class"=>"form-control select2"])?>
        </div>
        <div class="col-md-6">
               <div class="form-group">
                    <label class="control-label">Feature Image</label>
                    <input type="file" class="filestyle" data-buttonname="btn-default btn-sm" name="featureImage">
                </div>                                                     
            </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" value="<?= $data->seo_url?>" placeholder="Enter seo_url..." name="seo_url">
        </div>
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <textarea class="form-control" placeholder="Enter short Description..." id="shortDescription" name="shortDescription"><?= $data->shortDescription?></textarea>
        </div>
    </div>
    <div class="form-group">
        <div class="col-md-12">
            <label class="control-label">long Description</label>
            <textarea class="form-control" placeholder="Enter long Description..." id="longDescription" name="longDescription"><?= $data->longDescription?></textarea>
        </div>
    </div>
    ...
    <div class="form-group">
        <div class="col-md-6">
            ...
            <input type="text" class="form-control"  value="<?= $data->meta_title?>" placeholder="Enter meta_title..." name="meta_title">
        </div>
        <div class="col-md-6">
            <label class="control-label">meta keywords</label>
            <input type="text" class="form-control"  value="<?= $data->meta_title?>" placeholder="Enter meta_keywords..." name="meta_keywords">
        </div>
    ...
    <div class="form-group text-right m-b-0">
        <div class="col-md-12">
            <button class="btn btn-success waves-effect waves-light" type="submit" name="add-blogs" value="save blog category">Submit</button>
