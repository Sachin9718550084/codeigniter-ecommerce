					...
					<div class="col-12 col-sm-12 col-md-6 col-lg-9">
						...
						<div class="sort">
							...
							<ul class="nav nav-tabs" role="tablist">
								<li class="nav-item"><a class="nav-lin <?= isset($_GET['order'])?$_GET['order']=='new'?'active':'':'active';?>" href="<?= base_url('shop')?>?order=new">Newest First</a></li>
								<li class="nav-item"><a class="nav-lin <?= isset($_GET['order'])?$_GET['order']=='low'?'active':'':'';?>" href="<?= base_url('shop')?>?order=low">Price -- Low to High</a></li>
								<li class="nav-item"><a class="nav-lin <?= isset($_GET['order'])?$_GET['order']=='high'?'active':'':'';?>" href="<?= base_url('shop')?>?order=high">Price -- High to Low</a></li>
