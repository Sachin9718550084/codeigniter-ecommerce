			...
			<div class="mycontainer">
				...
				<div class="row mission">
					...
					<div class="col-12 col-sm-12 col-md-6 col-lg-6">
						...
						<img src="<?= base_url('assets/front/')?>images/welcome_img.jpg" alt="">

					</div>

					<div class="statement col-12 col-sm-12 col-md-6 col-lg-6">
					...
					<div class="col-12 col-sm-12 col-md-6 col-lg-6">
						...
						<img src="<?= base_url('assets/front/')?>images/welcome_img2.jpg" alt="">
